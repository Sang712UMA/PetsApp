...
public class Petsapp {
	...
	public static void main(String[] args) {
		...
		Advertisment a2 = new Advertisment("I am LF BabySitter for Boby", 3 , "Very quaiet snake.", null, Date.valueOf(LocalDate.now()),Date.valueOf(LocalDate.of(2019, 05, 13)), true);
